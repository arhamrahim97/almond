<div class="col-12 mb-3">
    <h5>Status: <i class="fas fa-circle text-secondary ml-2"></i> Digunakan, <i
            class="fas fa-circle text-warning ml-2"></i> Diperbaiki, <i class="fas fa-circle text-danger ml-2"></i> Rusak,
        <i class="fas fa-circle text-info ml-2"></i> Hilang, <i class="fas fa-circle text-primary ml-2"></i> Pengganti
    </h5>
</div>
