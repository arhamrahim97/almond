    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <!-- Button -->
                @auth
                    <a href="{{ route('dashboard') }}" class="navbar-btn btn btn-sm btn-primary lift ms-auto">
                        <span class="fe fe-monitor d-none d-md-inline p-0 m-0"></span> Beranda
                    </a>
                @else
                    <a href="{{ route('login') }}" class="navbar-btn btn btn-sm btn-primary lift ms-auto">
        ...
        <div class="container">
            <div class="row align-items-center text-center text-md-start">
                <div class="col-12 col-md-5 col-lg-6 order-md-1">
                    ...
                    <!-- Image -->
                    <img src="{{ asset('assets/img/imgLandingPage.png') }}" alt="..."
                ...
                <div class="col-12 col-md-7 col-lg-6 order-md-2 px-6" data-aos="fade-left">
                    ...
                    <h1 class="display-3 text-center text-md-start mb-2">
                        Selamat Datang di Aplikasi <span class="text-primary">SI PINTAR BERAKSI</span>
                    </h1>
                    <span class="text-primary mb-5" style="font-size: 22px">(Sistem Pengelolaan Inventaris Kantor
                        Berbasis Aplikasi)</span>

                    <div class="text-center text-md-start mt-4">
                        @auth
                            <a href="{{ route('dashboard') }}" class="btn btn-primary shadow lift me-1">
                                <span class="fe fe-monitor d-none d-md-inline p-0 m-0"></span> Beranda
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-primary shadow lift me-1">
                                <span class="fe fe-log-in d-none d-md-inline p-0 m-0"></span> Masuk
                            </a>
                        @endauth
                        <a href="http://sitedispusarda.sultengprov.go.id/" target="_blank"
                            class="btn btn-primary-soft lift">
                            Website DISPUSARDA <i class="fe fe-globe d-none d-md-inline ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 text-center" data-aos="fade-up" data-aos-delay="50">
                    ...
                    <ul class="list-unstyled text-muted mb-6 mb-md-8 mb-lg-0">
                        <li>
                            <span class="fe fe-phone"></span> (0451) 481490
                        </li>
                        <li>
                ...
                <div class="col-12 col-md-6 text-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-muted mb-0">
                        <i class="fe fe-map-pin"></i> Jl. Banteng No. 6, Birobuli Selatan, Kecamatan Palu Selatan, Kota
                        Palu,
                        Sulawesi Tengah
                    </p>
                ...
                <div class="col">
                    ...
                    <p class="text-center text-muted small mb-0">
                        ...
                        @endphp <a href="https://disp2kb.sultengprov.go.id/" target="_blank"
                            class="text-muted"> - DINAS PERPUSTAKAAN DAN KEARSIPAN DAERAH PROVINSI SULAWESI TENGAH</a>
                    </p>
                    <p class="text-center mb-0" style="font-size: 8pt">
                        <a href="https://www.freepik.com/vectors/warehouse">Warehouse vector created by storyset -
                            www.freepik.com</a>
                    </p>
